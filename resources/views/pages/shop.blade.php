...
<div class="banner_top innerpage" id="home">
		<div class="wrapper_top_w3layouts">
			<div class="header_agileits">
				<div class="logo inner_page_log">
					<h1><a class="navbar-brand" href="{{URL::to('/trangchu')}}"><span>Downy</span> <i>Shoes</i></a></h1>
				</div>
		...
		<div class="services-breadcrumb_w3ls_agileinfo">
			<div class="inner_breadcrumb_agileits_w3">
				...
				<ul class="short">
					<li><a href="{{URL::to('/trangchu')}}">Home</a><i>|</i></li>
					<li>Shop</li>
				</ul>
			</div>
		</div>
		...
		<div class="shop_inner_inf">
			...
			<div class="side-bar col-md-3">
				...
				<div class="deal-leftmk left-side">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('public/frontend/images/s2.jpg')}}" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('public/frontend/images/s1.jpg')}}" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
							<h3>Bella Toes</h3>
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('public/frontend/images/s5.jpg')}}" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
							<h3>Red Bellies</h3>
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('public/frontend/images/s3.jpg')}}" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
							<h3>(SRV) Sneakers</h3>
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men women_two">
							<div class="product-shoe-info shoe">
								<div class="men-pro-item">
									<div class="men-thumb-item">
										<img src="{{asset('public/frontend/images/s6.jpg')}}" alt="">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
						...
						<div class="col-md-4 product-men">
							<div class="product-shoe-info shoe">
								<div class="men-pro-item">
									<div class="men-thumb-item">
										<img src="{{asset('public/frontend/images/s7.jpg')}}" alt="">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
						...
						<div class="col-md-4 product-men">
							<div class="product-shoe-info shoe">
								<div class="men-pro-item">
									<div class="men-thumb-item">
										<img src="{{asset('public/frontend/images/s8.jpg')}}" alt="">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
						...
						<div class="col-md-4 product-men">
							<div class="product-shoe-info shoe">
								<div class="men-pro-item">
									<div class="men-thumb-item">
										<img src="{{asset('public/frontend/images/s9.jpg')}}" alt="">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
				...
				<div class="carousel-inner" role="listbox">
					<div class="item">
						<div class="row">
							...
							<div class="col-md-3 col-sm-3 col-xs-3 slidering">
								<div class="thumbnail"><img src="{{asset('public/frontend/images/g3.jpg')}}" alt="Image" style="max-width:100%;"></div>
							</div>
							<div class="col-md-3 col-sm-3 col-xs-3 slidering">
								<div class="thumbnail"><img src="{{asset('public/frontend/images/g4.jpg')}}" alt="Image" style="max-width:100%;"></div>
							</div>
						</div>
					</div>
